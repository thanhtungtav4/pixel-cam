 ...
 * and cart still work) but arranges them in the export's .pdp-layout. Product
 * data stays in WooCommerce; only the optional gift block is ACF-driven.
 *
 * @package Underscores
 */
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class('pdp-single', $product); ?>>
    ...
    <div class="wrap pdp-layout">
        ...
        <div class="pdp-info summary entry-summary">
             ...
             */
            // Gifts (@12) and stock (@28) are hooked in WooProductHook, so
            // they land in the right order before add-to-cart (@30).
